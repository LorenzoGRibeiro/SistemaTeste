...
namespace SistemaDeTeste.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataDeNascimento,Salario,Atividade")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataDeNascimento,Salario,Atividade")] Funcionarios funcionarios)
        {
